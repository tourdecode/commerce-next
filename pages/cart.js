...
const Cart = () => {
    ...
    const handleCHECKOUT = () => {
        ...
        addOrderShop({variables: {subtotal:subtotalToCheckout, vat: vatToCheckout, total: totalToCheckout}})
    }
                    ...
                    <Card className="text-left" style={{marginTop: '8%'}}>
                        ...
                        <Form.Group>
                            <Table responsive>
                                ...
                                <tbody>
                                {listItems && listItems.items instanceof Array && listItems.items.map(prod => (
                                    <tr style={{textAlign:'center'}}>
                                        <td><img src={prod.img} style={{width: '50px'}} /></td>
                                        <td>{prod.name}</td>
                                        <td>
                                            <div style={{display: 'flex', justifyContent:'center'}}>
                                                <button type="button" style={{border: "0 solid #e2e8f0"}} ><span >−</span></button>
                                                <Form.Control 
                                                    type="text" 
